...
import type { AuditLogModule } from '../../features/audit/enums/audit-log-module.enum';
import type { AuditAction } from '../../features/audit/enums/audit-action.enum';
...
const PlatformAuditPage: React.FC = () => {
  ...
  const queryParams = useMemo(
    () => ({
      ...
      ...(moduleFilter ? { module: moduleFilter as AuditLogModule } : {}),
